...
//вывод графа в виде матрицы смежности (с оформлением)
...
//вывод грава в виде списка смежности (с оформлением)
...
int main() {
	...
	LLv r = reverse(g); //созаём список смежности r по матрице смежности g
	printGraph(r); //выводим граф в виде списка смежности
	...
	printGraph(g); //выводим граф в виде матрицы смежности
	return 0;
}
